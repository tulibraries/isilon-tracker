...
ActiveRecord::Schema[7.2].define(version: 2026_02_02_141326) do
  ...
  create_table "isilon_assets", force: :cascade do |t|
    ...
    t.index ["full_isilon_path"], name: "index_isilon_assets_on_full_isilon_path"
